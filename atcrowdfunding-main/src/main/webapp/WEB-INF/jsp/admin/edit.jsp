        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="editForm" action="${PATH}/admin/doEdit" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input name="username" type="text" value="${admin.username}" class="form-control" id="exampleInputPassword2" placeholder="请输入用户名称">
                        </div>
                        <div class="form-group">
